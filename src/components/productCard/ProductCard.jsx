      ...
      <div className="card card-side bg-base-100 shadow-xl grid grid-cols-1 lg:flex">
        ...
        <div className="h-fit lg:h-80 py-16 px-2">
          ...
          <Link to={`/products/${brand}`}>
            <button type="button" className="ml-1 text-gray-900 bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800  font-medium rounded-lg text-sm px-2 py-2 text-center mr-2 mb-2">{brand}</button>
            </Link>
          </p>
            {/* <p>Brand: {brand}</p> */}
            <p>Type: {type}</p>
